(function() {
  var API, Promise, _, ansi_up, chalk, strip,
  ...
  API = {
    getMsgByType: function(type, arg1, arg2) {
      switch (type) {
        ...
        case "DEV_NO_SERVER":
          return " > The local API server isn't running in development. This may cause problems running the GUI.";
        case "NO_PROJECT_ID":
