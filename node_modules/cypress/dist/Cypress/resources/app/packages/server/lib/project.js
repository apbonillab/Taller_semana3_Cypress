(function() {
  var Automation, EE, Project, Promise, Reporter, Server, Watchers, _, api, cache, config, cwd, debug, errors, fs, git, glob, ids, localCwd, log, logger, multipleForwardSlashesRe, path, savedState, scaffold, scaffoldLog, settings, user,
  ...
  Project = (function(superClass) {
    ...
    Project.prototype.open = function(options) {
      ...
      this.server = Server(this.watchers);
      _.defaults(options, {
        report: false,
        ...
        return function(cfg) {
          ...
          return _this.server.open(cfg, _this).spread(function(port, warning) {
            ...
            return Promise.join(_this.watchSettingsAndStartWebsockets(options, cfg), _this.scaffold(cfg)).then(function() {
              return _this.watchSupportFile(cfg);
            });
          });
        };
      })(this))["return"](this);
    ...
    Project.prototype.close = function() {
      ...
      this.cfg = null;
      return Promise.join((ref = this.server) != null ? ref.close() : void 0, (ref1 = this.watchers) != null ? ref1.close() : void 0).then(function() {
      ...
      if (supportFile = config.supportFile) {
        return fs.pathExists(supportFile).then((function(_this) {
          return function(found) {
            ...
            return _this.watchers.watchBundle(relativePath, config, options)["catch"](function() {});
          };
        })(this));
      } else {
    ...
    Project.prototype.watchSettingsAndStartWebsockets = function(options, config) {
      ...
      return this.server.startWebsockets(this.watchers, this.automation, config, {
    ...
    Project.prototype.createCiProject = function(projectDetails) {
      return user.ensureAuthToken().then((function(_this) {
        return function(authToken) {
          return git.init(_this.projectRoot).getRemoteOrigin().then(function(remoteOrigin) {
