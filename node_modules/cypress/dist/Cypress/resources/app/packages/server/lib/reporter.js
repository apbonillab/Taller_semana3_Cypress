(function() {
  var Mocha, Reporter, STATS, _, chalk, createRunnable, createSuite, events, log, mergeErr, mergeRunnable, mochaReporters, path, reporters, safelyMergeRunnable,
    slice = [].slice;
  ...
  mergeErr = function(test, runnables) {
    var runnable;
  ...
  Reporter = (function() {
    ...
    Reporter.prototype.parseArgs = function(event, args) {
      ...
      if (e = events[event]) {
        if (_.isFunction(e)) {
          args = e.apply(this, args.concat(this.runnables));
        }
    ...
    Reporter.prototype.stats = function() {
      ...
      stats = this.reporter ? this.reporter.stats : {};
      return _.extend({
