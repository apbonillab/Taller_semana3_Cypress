...
var parseOpts = function parseOpts(opts) {
  return _.pick(opts, 'spec', 'reporter', 'reporterOptions', 'path', 'destination', 'port', 'env', 'cypressVersion', 'config', 'record', 'key', 'browser', 'detached');
};
...
var knownCommands = ['version', 'run', 'open', 'install', 'verify', '-v', '--version'];
